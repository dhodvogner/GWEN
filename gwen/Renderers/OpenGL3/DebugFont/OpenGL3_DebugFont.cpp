...
namespace Gwen
{
	namespace Renderer
	{
		OpenGL3_DebugFont::OpenGL3_DebugFont()
		{
		...
		void OpenGL3_DebugFont::Init(int _windowWidth, int _windowHeight)
		{
			OpenGL3::Init(_windowWidth, _windowHeight);
			CreateDebugFont();
		}
		...
		void OpenGL3_DebugFont::CreateDebugFont()
		{
		...
		void OpenGL3_DebugFont::DestroyDebugFont()
		{
			if ( !m_pFontTexture ) { return; }
		...
		void OpenGL3_DebugFont::RenderText( Gwen::Font* pFont, Gwen::Point pos, const Gwen::UnicodeString & text )
		{
		...
		Gwen::Point OpenGL3_DebugFont::MeasureText( Gwen::Font* pFont, const Gwen::UnicodeString & text )
		{
			Gwen::Point p;
			float fSize = pFont->size * Scale();
			Gwen::String converted_string = Gwen::Utility::UnicodeToString( text );
